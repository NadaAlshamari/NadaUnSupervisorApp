...
/// </summary>
/// 
namespace unSupervisorApp.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["unSupervisorConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["unSupervisorConStr"].ConnectionString);
        public CRUD()
        {
            //
